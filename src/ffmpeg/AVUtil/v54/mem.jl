...
function av_calloc(nmemb::Integer,size::Integer)
...
function av_strndup(s,len::Integer)
    ccall((:av_strndup,libavutil),Ptr{Uint8},(Ptr{Uint8},Csize_t),s,len)
end

function av_memdup(p,size::Integer)
